export default function Testimonials() {
    return (
        <>
            <div className="mx-auto px-4 py-10 bg-[#4a5e57] w-full">
                ...
                <div className="flex flex-wrap gap-6 justify-center">
                    <div className="card bg-base-100 w-96 shadow-sm">
                        <div className="card-body text-xl">
                            <h2 className="card-title">Donda West</h2>
                            <p>The food here really refreshed me after a late night shift</p>
                    ...
                    <div className="card bg-base-100 w-96 shadow-sm">
                        <div className="card-body text-xl">
                            <h2 className="card-title">Tyler Okonma</h2>
                    ...
                    <div className="card bg-base-100 w-96 shadow-sm">
                        <div className="card-body text-xl">
                            <h2 className="card-title">Jordan Carter</h2>
                    ...
                    <div className="card bg-base-100 w-96 shadow-sm">
                        <div className="card-body text-xl">
                            <h2 className="card-title">Lana</h2>
                    ...
                    <div className="card bg-base-100 w-96 shadow-sm">
                        <div className="card-body text-xl">
                            <h2 className="card-title">Lizzie Skevington</h2>
                    ...
                    <div className="card bg-base-100 w-96 shadow-sm">
                        <div className="card-body text-xl">
                            <h2 className="card-title">Aubrey Graham</h2>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="-mt-10"><path fill="#4b5e57" fill-opacity="1" d="M0,256L40,250.7C80,245,160,235,240,202.7C320,171,400,117,480,106.7C560,96,640,128,720,160C800,192,880,224,960,202.7C1040,181,1120,107,1200,85.3C1280,64,1360,96,1400,112L1440,128L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>
        </>
    )
}